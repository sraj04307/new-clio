                        ...
                        <div className="col-lg-6">
                            <div className="contact-content">
                                ...
                                <form>
                                    ...
                                    <div className="d-flex gap-2 mb-3">
                                        <input type="tel" placeholder='Contact' className='w-100' />
                                        <input type="text" placeholder='Reference' className='w-100'/>
                                    ...
                                    <div className="mb-3">
                                        <textarea name="" id="" placeholder='Message' className='w-100'></textarea>
                                    </div>
