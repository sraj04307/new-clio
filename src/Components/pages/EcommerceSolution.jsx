...
import img7 from '../../assets/img/Banner2/Ecommerce.jpg'
...
const EcommerceSolution = () => {
  ...
  return (
    <>
      <Banner2 message={"Ecommerce solution"} image={img7}/>
      <section className="Ecom-section1 section-padding">
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-6 content-box">
              <h2 className='sr-subheading-font-size'>One-Stop Solution For Web Development</h2>
      ...
      <section className="Ecom-section2 bg-light section-padding">
        <div className="container">
          <h2 className="text-center sr-subheading-font-size">Our Exclusive Website Development Service</h2>
      ...
      <section class="Ecom-section3 section-padding">
        <div class="container">
          <div class="row text-center">
            <div class="col-12">
              <h2 class="mb-4 sr-subheading-font-size">Industries We Famous for Website Development</h2>
            </div>
          </div>
          <div class="row">
      ...
      <section className='Ecom-section4 section-padding'>
        <div className="container">
          <div className="row ">
      ...
      <section className='Ecom-section5 section-padding '>
        <div className="container">
