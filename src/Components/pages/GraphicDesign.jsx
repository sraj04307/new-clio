...
import '../../assets/css/Graphidesign.css'
...
import img11 from '../../assets/img/graphic design/graphic.jpg'
...
const GraphicDesign = () => {
  ...
  return (
    <>
      ...
      <section className="Graphicdesign-section1 section-padding">
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-md-6 image-box">
              <img src={img11} alt="Web Development" className="img-fluid" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="Graphicdesign-section3 section-padding">
        <div className="container">
